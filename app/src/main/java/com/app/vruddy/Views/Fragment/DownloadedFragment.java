...
import com.app.vruddy.Views.Adapter.DownloadedFileTabLayoutAdapter;
...
public class DownloadedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DownloadedFileTabLayoutAdapter downloadedFileTabLayoutAdapter = new DownloadedFileTabLayoutAdapter(getActivity().getSupportFragmentManager());
        viewPager.setAdapter(downloadedFileTabLayoutAdapter);
