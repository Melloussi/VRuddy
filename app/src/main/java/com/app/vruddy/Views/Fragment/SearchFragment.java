...
import com.app.vruddy.Views.Adapter.SuggestionAdapter;
import com.app.vruddy.Data.Background.AsyncTask.SuggestionsRequest;
import com.app.vruddy.Data.Background.AsyncTask.getSearchVideo;
import com.app.vruddy.Views.Adapter.searchVideoAdapter;
                ...
                if (searchVideo.getVideoId().size() > 1) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            searchVideoAdapter.setOnItemClickListener(new com.app.vruddy.Views.Adapter.searchVideoAdapter.onItemClickListener() {
                                @Override
                                public void onItemClick(int position) {
                                    //open watch activity
